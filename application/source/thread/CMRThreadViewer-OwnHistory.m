/*
 * $Id: CMRThreadViewer-OwnHistory.m,v 1.6.2.2 2006/11/12 22:43:27 tsawada2 Exp $
 *
...
{
	if ([[item itemIdentifier] isEqualToString: @"scaleSC"]) return [self shouldShowContents];
